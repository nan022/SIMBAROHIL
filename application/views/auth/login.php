		...
		<div class="m-grid m-grid--hor m-grid--root m-page">
			<div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-grid--tablet-and-mobile m-grid--hor-tablet-and-mobile m-login m-login--1 m-login--signin" id="m_login">
						...
						<div class="m-stack__item m-stack__item--fluid">
							<div class="m-login__wrapper">
								<div class="m-login__logo">
									<a href="#">
										<img src="<?= base_url('assets/') ?>demo/default/media/img/logo/SIMBA.png">
									</a>
								</div>
								...
								<div class="m-login__signup">
									...
									<form class="m-login__form m-form" method="post" action="<?= base_url('auth'); ?>">
										<div class="form-group m-form__group">
											<input class="form-control m-input" type="text" placeholder="Nama Lengkap" name="fullname">
										</div>
										<div class="form-group m-form__group">
										...
										<div class="form-group m-form__group">
											<input class="form-control m-input m-login__form-input--last" type="password" placeholder="Konfirmasi Password" name="rpassword">
										</div>
										...
										<div class="m-login__form-action">
											<button id="m_login_signup_submit" class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air">Daftar</button>
				...
				<div class="m-grid__item m-grid__item--fluid m-grid m-grid--center m-grid--hor m-grid__item--order-tablet-and-mobile-1	m-login__content m-grid-item--center" style="background-image: url(<?= base_url('assets/') ?>app/media/img//bg/bg-4.jpg)">
					<div class="m-grid__item">
						<h3 class="m-login__welcome">SIMBA ROHIL</h3>
						<p class="m-login__msg">
							SIMBA ROHIL adalah aplikasi berbasis web Dinas Pendidikan dan Kebudayaan yang ada di
							<br>Rokan Hilir untuk memanajamen seluruh beasiswa yang ada.
						</p>
					</div>
				</div>
			</div>
