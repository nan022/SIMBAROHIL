							...
							<section>
								<div class="form-wrap max-width-600 mx-auto">
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<input name="nama" id="nama" type="email" class="form-control">
										</div>
									</div>
									<div class="form-group row">
									...
									<div class="row">
										<div class="col-sm-12">
											<div class="input-group mb-0">												
												...
												<button class="btn btn-primary btn-lg btn-block" href="<?= base_url('auth/registrasi'); ?>" type="button" id="success-modal-btn" data-toggle="modal" data-target="#success-modal" data-backdrop="static">Daftar</button>
												<div class="modal fade" id="success-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
													<div class="modal-dialog modal-dialog-centered max-width-400" role="document">
														<div class="modal-content">
															<div class="modal-body text-center font-18">
																<h3 class="mb-20">Berhasil!</h3>
																<div class="mb-30 text-center"><img src="<?= base_url('assets/') ?>vendor/images/success.png"></div>
